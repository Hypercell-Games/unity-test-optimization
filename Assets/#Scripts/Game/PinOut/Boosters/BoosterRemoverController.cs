...
namespace Unpuzzle
{
    public class BoosterRemoverController : MonoBehaviour
    {
        [SerializeField] private BoosterRemoverButton _button;
        ...
        {
            _isEnabled = !_levelsController.CurrentGameController.IsRocketBoosterNotSupport();
