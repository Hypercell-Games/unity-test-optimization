Shader "HyperShaderWithOutline"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform fixed4 _SpecularColor,_Color;
            float4 _Curvature;
            ...
            vertexOutput vert(vertexInput v)
            {
                ...
                fixed4 selfShadow = _SelfShadowColor;

                colored = lerp(colored, colored * selfShadow.xyz, diff * selfShadow.a);
                ...
                fixed4 falloffColor = _FalloffColor;

                o.col = float4(colored, 1.0) + specular;
                o.col = lerp(o.col, falloffColor, fresnel);
                o.pos = UnityObjectToClipPos(v.vertex);
                //spec end
