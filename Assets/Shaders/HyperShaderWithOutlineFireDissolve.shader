Shader "HyperShaderWithOutlineFireDissolve"
{
    Properties
    {
        ...
        _OutlineThickness("_OutlineThickness", float) = 0.05
            ...
            _FireSource("_FireSource", Vector) = (0,0,0)
            _FireRadius("_FireRadius", float) = 0
    }
    SubShader
    {
             Pass
        {
             Tags
            {
            "LightMode" = "ForwardBase" "Queue" = "Transparent"
            ...
            float distance = clamp(length(i.wpos - _FireSource) - _FireRadius, 0, 1);
            c.a = distance;
                return c;
            }
            ENDCG
        ...
        Pass
        {
            ...
            float4 frag(vertexOutput i) : COLOR
            {
                ...
                c = lerp(c, float4(1, 0, 0, 1), (1 - distance)*2);
