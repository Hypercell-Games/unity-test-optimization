                ...
                if (textureSheetAnimation.enabled)
                {
                    ...
                    switch (textureSheetAnimation.animation)
                    {
                        ...
                        case ParticleSystemAnimationType.WholeSheet:
                            if (textureSheetAnimation.startFrame.mode == ParticleSystemCurveMode.TwoConstants)
                            {
                                float fmin = textureSheetAnimation.startFrame.constantMin;
                                float fmax = textureSheetAnimation.startFrame.constantMax;
                                float frand = Mathf.Abs((int)particle.randomSeed % textureSheetAnimationFrames);
                                frame = Mathf.FloorToInt(frand + frameProgress * textureSheetAnimationFrames);
                            }
                            else
                            {
